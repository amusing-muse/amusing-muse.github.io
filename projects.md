...
__Status:__ (12/12/16) Very little. Tomás has done characterisation in .csv table and can use that. Discussion on whether to write a messenger article?
...
__Status:__ (12/12/16) None. If someone else wishes to take over then no problem! (05/04/17): Still none. (05/09/17)  Lluís now taken over. He will add the AMUSING SNIa sample to those observed with PMAS and MaNGA. Aim to have draft before the end of 2017.
...
__Status:__ (06/09/17) No updates.
...
__Status:__ (06/09/17) Alessandro recently arrived at ESO to start his thesis project which will be working on this project. Significant progress expected in the coming months.
...
__Data usage:__ All semesters  
__Status:__ (10/09/17) Machinery is in place, now waiting for data...
...
__Data usage:__ All semesters  
__Status:__ (11/09/17) now has a PhD student who may work on this, trying to have a draft by mid-2018.
...
Abstract: Along the last 30 years it has grown evidence of the presence of an oxygen abundance gradient in spiral galaxies that has been interpreted as an evidence of inside-out growth. More recently it has been proposed the presence of a common abundance gradient and central decrement correlated with the mass of galaxies, by the use of IFU surveys. However, its characterization is hampered by the coarse resolution of those surveys (CALIFA, PINGS, MaNGA...), thus we would like to explore it by the analysis of the HII regions within the AMUSING dataset.
__Data usage:__ All semesters  
__Status:__ (03/10/17) [Accepted](https://arxiv.org/abs/1710.01188)
...
__Data usage:__ All semesters  
__Status:__ (06/09/17) No significant progress. Will try to push things soon.
...
__Data usage:__ P95  
__Status:__ (06/11/17) [Accepted](https://arxiv.org/abs/1711.02785)
...
__Data usage:__ All semesters  
__Status:__ (06/09/17) Data was used in summer school, not clear if any further analysis? 
...
Abstract:  
__Data usage:__ P96  
__Status:__ (06/09/17) Paper in prep. Early draft is circulating.
...
__Status:__ (06/09/17) submitted to Nature Astronomy. Sent back to editor after 2nd referee reports.
...
Abstract:   
__Data usage:__ HK  
__Status:__ (26/03/17) [Published](http://adsabs.harvard.edu/abs/2017arXiv170205430K)
...
__Status:__ (06/09/17) Building sample from other sources (PMAS, HexPaK, KOALA). Adding some southern targets for P101
...
__Data usage:__ All semesters  
__Status:__ (06/09/17) Applying for funding to perform the study
...
__Data usage:__ All semesters  
__Status:__ (06/09/17) Analysis ready, waiting for a student to work on this
...
__Data usage:__ All semesters  
__Status:__ (06/09/17) Jairo is looking for students this autumn. If no students he will start working on the data himself.
...
__Data usage:__ All semesters  
__Status:__ (12/09/17) No progress currently, but a student (Aitor Robleto-Orús) is to start working on this soon.
...
__Status:__ (06/09/17) Waiting for data.
...
__Status:__ (05/04/17) Just been sent data. (13/09/17) Currently using data to simulate adding a quasar to MUSE cube and moving it to z=1.5...
...
__Status:__ (10/09/17) A bachelor thesis was written on this subject. Therefore, data/analysis/results are available, but needs someone to write up.

### Project AM26
__Title:__ _Wolf-Rayet population in NGC 3451_  
__PI:__ L. Galbany, A. R. López-Sánchez  
Abstract:  
__Data usage:__ SN1997dn host (from HK P95)  
__Status:__ (06/09/17) SDSS, PMAS, and MUSE data ready. No significant advances. (01/12/17) Data anlayzed. Plan to work 100% on this during my visit to Angel in May.
...
__Status:__ (10/09/17) are waiting for MANGA data to become public to enable project to start. 
