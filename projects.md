...
### Project SV1
*Title:* _Census of H II regions in NGC 6754 derived with MUSE: Constraints on the metal mixing scale_  
*PI:* S. Sánchez  
*Data usage:* SV  
*Status:* [Published](http://adsabs.harvard.edu/abs/2015A%26A...573A.105S)

### Project SV2
*Title:* _Characterizing the environments of supernovae with MUSE_  
*PI:* L. Galbany  
*Data usage:* SV  
*Status:* [Published](http://adsabs.harvard.edu/abs/2016MNRAS.455.4087G)  

### Project SV3
*Title:* _Evidence of Ongoing Radial Migration in NGC 6754: Azimuthal Variations of the Gas Properties_  
*PI:* L. Sánchez-Menguiano  
*Data usage:* SV  
*Status:* [Published](http://adsabs.harvard.edu/abs/2016ApJ...830L..40S)

### Project AM1
*Title:* _Data release of P95+P96+P97+P98_  
*PI:* J. Anderson  
...
*Status:* (12/12/16) Very little. Tomás has done characterisation in .csv table and can use that. Discussion on whether to write a messenger article?
 (05/04/17) Still little progress, but we really need to get something done here. JA to try to make higher priority. (05/09/17) Draft started. Aim to send draft to collaboration before end of 2017.

### Project AM2
*Title:* _Environments w.r.t. SNIa properties_  
...
*Status:* (12/12/16) None. If someone else wishes to take over then no problem! (05/04/17): Still none. (05/09/17)  Lluís now taken over. He will add the AMUSING SNIa sample to those observed with PMAS and MaNGA. Aim to have draft before the end of 2017.

### Project AM3
*Title:* _Exploring the SNe environments and related issues through their narrow absorption lines_  
*PI:* L. Wang  
...
### Project AM4
*Title:* _Extinction laws towards supernova host galaxies with integral field spectroscopy_  
*PI:* A. Razza  
...
### Project AM5
*Title:* _Search for long-lived SN Halpha emission_  
...
### Project AM6
*Title:* _On the diffuse gas in spiral galaxies using MUSE IFS data_  
...
### Project AM7
*Title:* _BaTMAn: A coherent segmentation map code_  
*PI:* Javier Casado  
...
### Project AM8
*Title:* _Oxygen abundance gradients + central decrement_  
*PI:* L. Sánchez-Menguiano  
Abstract: Along the last 30 years it has grown evidence of the presence of an oxygen abundance gradient in spiral galaxies that has been interpreted as an evidence of inside-out growth. More recently it has been proposed the presence of a common abundance gradient and central decrement correlated with the mass of galaxies, by the use of IFU surveys. However, its characterization is hampered by the coarse resolution of those surveys (CALIFA, PINGS, MaNGA...), thus we would like to explore it by the analysis of the HII regions within the AMUSING dataset.
*Data usage:* All semesters  
...
### Project AM9
*Title:* _The global and local MZ relation explored with MUSE_  
*PI:* L. Sánchez-Menguiano  
...
### Project AM10
*Title:* _Azimutal variations of stellar properties_  
*PI:* T. Ruiz-Lara  
...
### Project AM11
*Title:* _Sulphur electron temperatures_  
*PI:* R. García-Benito  
...
### Project AM12
*Title:* _Unveiling the sources of disk heating in spiral galaxies_  
...
### Project AM13
*Title:* _Emission line associated with a AGN driven jet in NGC232_  
*PI:* C. Cobá  
...
### Project AM14
*Title:* _Unsupervised classification of spectra_  
*PI:* F. Förster  
...
### Project AM15
*Title:* _MUSE Reveals a Recent Merger in the Post-starburst Host Galaxy of the TDE ASASSN-14li_  
*PI:* J. L. Prieto  
*Data usage:* P96  
*Status:* [Published](http://adsabs.harvard.edu/abs/2016ApJ...830L..32P)

### Project AM16
*Title:* _ASASSN-14jb (SN II) host and SN properties_  
*PI:* N. Meza  
Abstract:  
*Data usage:* P96  
...
### Project DDT1
*Title:* _The lowest metallicity type II supernova from a high mass red-supergiant progenitor_  
*PI:* J. Anderson  
...
*Data usage:* DDT96  
*Status:* (06/09/17) submitted to Nature Astronomy. Sent back to editor after 2nd referee reports.

### Project HK1
*Title:* _Hot gas around SN~1998bw - the progenitor from its environment_  
*PI:* T. Kruehler  
Abstract:   
*Data usage:* HK  
...
### Project AM17
*Title:* _SweetSpot NIR SNIa LC/HR correlations with host galaxy properties_  
*PI:* L. Galbany  
...
### Project AM18
*Title:* _SN Ia and CCSN delay time distribution (DTD) measurement_  
*PI:* L. Galbany  
...
### Project AM19
*Title:* _young/old supernova remnants detection_  
*PI:* L. Galbany  
...
### Project AM20
*Title:* _The Origins of Galaxy Bimodality: Quenching Mechanisms over the last 8 Gyrs_  
*PI:* J. Méndez-Abreu  
...
### Project AM21  
*Title:* _The star formation history of the perturbed Virgo cluster galaxy NGC 4424_  
...
### Project AM22
*Title:* _On the interaction between nuclear star formation and AGN in nearby galaxies_  
...
### Project AM23
*Title:* _SN nebular spectroscopy_  
*PI:* H. Kuncarayakti  
...
### Project AM24
*Title:* _Simulating the host galaxies of quasars as seen by HARMONI_  
*PI:* A. Monreal-Ibero  
...
*Status:* (05/04/17) Just been sent data. (13/09/17) Currently using data to simulate adding a quasar to MUSE cube and moving it to z=1.5...

### Project AM25
*Title:* _AGN feedback in AMUSING galaxies_  
*PI:* Y. Ascasibar  
...
### Project AM26
*Title:* _Wolf-Rayet population in NGC 3451_  
*PI:* L. Galbany, A. R. López-Sánchez  
Abstract:  
*Data usage:* SN1997dn host (from HK P95)  
*Status:* (06/09/17) SDSS, PMAS, and MUSE data ready. No significant advances. (01/12/17) Data anlayzed. Plan to work 100% on this during my visit to Angel in May.

### Project AM27
*Title:* _Spatial resolution effects in Nearby Galaxies: An AMUSING-MaNGA synergy_  
...
### Project AM28
*Title:* _Serendipitous discovery of a lensed galaxy in IFS data_  
...
*Status:* (01/12/17) Preliminar analysis finished, now simulating the lens to subtract from the cube and repeat the analysis.
